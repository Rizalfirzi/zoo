                        ...
                        <div class="row justify-content-center">
                            <div class="steps col-md-12">
                                <ul class="nav nav-pills mb-3 d-flex flex-wrap" id="pills-tab" role="tablist">
                                    ${response.track.map(element => `
                                        <li class="nav-item col-6 col-md-auto" role="presentation">
                                            <button class="step nav-link ${element.name == response.last ? 'active' : ''}" id="pills-${element.name.toLowerCase().replace(/\s/g, '')}-tab" data-bs-toggle="pill" data-bs-target="#pills-${element.name.toLowerCase().replace(/\s/g, '')}" type="button" role="tab" aria-controls="pills-${element.name.toLowerCase().replace(/\s/g, '')}" aria-selected="false">
                                                ${element.name == response.last ? '<center><div class="badge bg-success mb-2">&#x2713;</div></center>' : '<center><div class="mb-2"><br></div></center>'}
                                                <div class="step-icon-wrap">
                                                    <div class="step-icon"><i class="${element.icon}"></i></div>
                                                </div>
                                ...
                                <div>
                                    <div class="timeline">
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade show ${last === 'penjadwalansidang' ? 'active' : ''}" id="pills-penjadwalansidang" role="tabpanel" aria-labelledby="pills-penjadwalansidang-tab">
                                            ${response.history_pengaduan.data
                                            ...
                                            <div class="tab-pane fade show ${last === 'penjadwalansidangputusan' ? 'active' : ''}" id="pills-penjadwalansidangputusan" role="tabpanel" aria-labelledby="pills-penjadwalansidangputusan-tab">
                                            ${response.history_pengaduan.data
                                                .filter(element => element.status_sidang > 5 && element.proses_sidang !== null && element.proses_sidang == 'proses')
                                                .map((element, index) => {
                                                    let message;
