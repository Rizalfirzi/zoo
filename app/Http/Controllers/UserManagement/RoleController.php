...
class RoleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $hakAksesCreate = $this->aksesUserManagement($user->id, 'Role Management', 'create');
        $hakAksesUpdate = $this->aksesUserManagement($user->id, 'Role Management', 'update');
    ...
    {
        $user = Auth::user();
        $hakAksesEdit = $this->aksesUserManagement($user->id, 'Role Management', 'update');
